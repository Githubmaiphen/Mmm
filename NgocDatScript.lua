...
function TP2(P1)
    ...
    function Text(value)
		game.StarterGui:SetCore("SendNotification", {
			Title = "Ngoc Dat Hub Notification", 
			Text = tostring(value),
			Icon = "http://www.roblox.com/asset/?id=16207220161",
			Duration = 10
		})
	end
...
local Library = Update:Window("Ngoc Dat Hub","2.0",Enum.KeyCode.RightControl);
...
Main:Label("Ngoc Dat Hub Hub By Ngoc Dat")
